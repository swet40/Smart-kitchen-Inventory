        ...
        <Container maxWidth="lg">
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
                <Grid item xs={12} sm={6} md={3}>
                    <Card component={Link} to="/waste-alerts" sx={{ textDecoration: 'none', cursor: 'pointer' }}>
                        <CardContent sx={{ textAlign: 'center' }}>
                            <WarningIcon color="warning" sx={{ fontSize: 40, mb: 1 }} />
                            <Typography variant="h6">Waste Alerts</Typography>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Card component={Link} to="/meal-planner" sx={{ textDecoration: 'none', cursor: 'pointer' }}>
                        <CardContent sx={{ textAlign: 'center' }}>
